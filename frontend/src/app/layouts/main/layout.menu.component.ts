...
export class LayoutMenuComponent implements OnInit {
  ...
  ngOnInit() {
    this.model = [
      { label: 'Dashboard', icon: 'dashboard', routerLink: ['/home'] },
      { label: 'Contacts', icon: 'contacts', routerLink: ['/contact'] },
          ...
          items: [
            {
              ...
              items: [
                ...
                },
                {
                  label: 'Submenu 1.2',
                  icon: 'subject',
                  items: [{ label: 'Submenu 1.2.1', icon: 'subject' }, { label: 'Submenu 1.2.2', icon: 'subject' }],
                },
              ],
            },
            {
              ...
              items: [
                ...
                },
                {
                  label: 'Submenu 2.2',
                  icon: 'subject',
                  items: [{ label: 'Submenu 2.2.1', icon: 'subject' }, { label: 'Submenu 2.2.2', icon: 'subject' }],
                },
              ],
            },
          ],

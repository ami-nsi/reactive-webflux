                ...
                <ul class="topbar-items animated fadeInDown" [ngClass]="{'topbar-items-visible': app.topbarMenuActive}">
                    <li #profile class="profile-item" *ngIf="app.profileMode==='top'||app.isHorizontal()" [hidden]="!app.layout.profileView"
                        ...
                        <a href="#" (click)="app.onTopbarItemClick($event,profile)">
                            ...
                            <span class="topbar-item-name">NSI IT Software & Services</span>
                        </a>
                    ...
                    <li #settings [ngClass]="{'active-top-menu':app.activeTopbarItem === settings}" *ngIf="app.layout.settingsView">
                    ...
                    <li #notifications [ngClass]="{'active-top-menu':app.activeTopbarItem === notifications}" *ngIf="app.layout.notiView">
                    ...
                    <li #language [ngClass]="{'active-top-menu':app.activeTopbarItem === language}" *ngIf="isMultiLang">
                        ...
                        <ul class="topbar-language ultima-menu animated fadeInDown">
                            <li *ngFor="let lang of i18n.langs" role="menuitem">
                                <a href="#" class="topbar-message" (click)="onLangChange(lang)">
                                    <img src="assets/images/i18n/{{lang}}.png" width="35"/>
